...
export type TestActions = {
     ...
     * })
     */
    sendUnsignedTransaction: <chain extends Chain | undefined>(args: SendUnsignedTransactionParameters<chain>) => Promise<SendUnsignedTransactionReturnType>;
    /**
...
export declare function testActions<mode extends TestClientMode>({ mode, }: {
    mode: mode;
}): <transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined>(client: Client<transport, chain, account>) => TestActions;
