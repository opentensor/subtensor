...
class Blake1 extends utils_js_1.Hash {
    ...
    update(data) {
        ...
        for (let pos = 0; pos < len;) {
            ...
            if (take === blockLen) {
                if (!dataView)
                    dataView = (0, utils_js_1.createView)(data);
    ...
    digestInto(out) {
        ...
        (0, _md_js_1.setBigUint64)(view, blockLen - 8, counter, false);
        this.compress(view, 0, this.pos !== 0); // don't add length if length is not empty block?
        // Write output
        buffer.fill(0);
        const v = (0, utils_js_1.createView)(out);
...
function generateTBL256() {
    ...
    for (let i = 0, j = 0; i < 14; i++, j += 16) {
        for (let offset = 1; offset < 16; offset += 2) {
            TBL.push(C256[_blake_js_1.SIGMA[j + offset]]);
            TBL.push(C256[_blake_js_1.SIGMA[j + offset - 1]]);
        }
    }
...
class Blake1_32 extends Blake1 {
    ...
    compress(view, offset, withLength = true) {
        ...
        const { h, l } = (0, _u64_js_1.fromBig)(BigInt(withLength ? this.length * 8 : 0));
        ...
        for (let i = 0, k = 0, j = 0; i < 14; i++) {
            ({ a: v00, b: v04, c: v08, d: v12 } = (0, blake2s_js_1.G1s)(v00, v04, v08, v12, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v00, b: v04, c: v08, d: v12 } = (0, blake2s_js_1.G2s)(v00, v04, v08, v12, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v01, b: v05, c: v09, d: v13 } = (0, blake2s_js_1.G1s)(v01, v05, v09, v13, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v01, b: v05, c: v09, d: v13 } = (0, blake2s_js_1.G2s)(v01, v05, v09, v13, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v02, b: v06, c: v10, d: v14 } = (0, blake2s_js_1.G1s)(v02, v06, v10, v14, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v02, b: v06, c: v10, d: v14 } = (0, blake2s_js_1.G2s)(v02, v06, v10, v14, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v03, b: v07, c: v11, d: v15 } = (0, blake2s_js_1.G1s)(v03, v07, v11, v15, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v03, b: v07, c: v11, d: v15 } = (0, blake2s_js_1.G2s)(v03, v07, v11, v15, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v00, b: v05, c: v10, d: v15 } = (0, blake2s_js_1.G1s)(v00, v05, v10, v15, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v00, b: v05, c: v10, d: v15 } = (0, blake2s_js_1.G2s)(v00, v05, v10, v15, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v01, b: v06, c: v11, d: v12 } = (0, blake2s_js_1.G1s)(v01, v06, v11, v12, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v01, b: v06, c: v11, d: v12 } = (0, blake2s_js_1.G2s)(v01, v06, v11, v12, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v02, b: v07, c: v08, d: v13 } = (0, blake2s_js_1.G1s)(v02, v07, v08, v13, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v02, b: v07, c: v08, d: v13 } = (0, blake2s_js_1.G2s)(v02, v07, v08, v13, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v03, b: v04, c: v09, d: v14 } = (0, blake2s_js_1.G1s)(v03, v04, v09, v14, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
            ({ a: v03, b: v04, c: v09, d: v14 } = (0, blake2s_js_1.G2s)(v03, v04, v09, v14, BLAKE256_W[_blake_js_1.SIGMA[k++]] ^ TBL256[j++]));
        }
...
function generateTBL512() {
    ...
    for (let r = 0, k = 0; r < 16; r++, k += 16) {
        for (let offset = 1; offset < 16; offset += 2) {
            TBL.push(C512[_blake_js_1.SIGMA[k + offset] * 2 + 0]);
            TBL.push(C512[_blake_js_1.SIGMA[k + offset] * 2 + 1]);
            TBL.push(C512[_blake_js_1.SIGMA[k + offset - 1] * 2 + 0]);
            TBL.push(C512[_blake_js_1.SIGMA[k + offset - 1] * 2 + 1]);
        }
    }
    return new Uint32Array(TBL);
}
...
function G1b(a, b, c, d, msg, k) {
    const Xpos = 2 * _blake_js_1.SIGMA[k];
    ...
    Ah = _u64_js_1.default.add3H(ll, Ah, Bh, Xh) >>> 0;
    Al = (ll | 0) >>> 0;
    // v[d] = rotr(v[d] ^ v[a], 32)
    ...
    ({ Bh, Bl } = { Bh: _u64_js_1.default.rotrSH(Bh, Bl, 25), Bl: _u64_js_1.default.rotrSL(Bh, Bl, 25) });
...
function G2b(a, b, c, d, msg, k) {
    ...
    // v[b] = rotr(v[b] ^ v[c], 11)
    ({ Bh, Bl } = { Bh: Bh ^ Ch, Bl: Bl ^ Cl });
    ({ Bh, Bl } = { Bh: _u64_js_1.default.rotrSH(Bh, Bl, 11), Bl: _u64_js_1.default.rotrSL(Bh, Bl, 11) });
    (BBUF[2 * a + 1] = Al), (BBUF[2 * a] = Ah);
    (BBUF[2 * b + 1] = Bl), (BBUF[2 * b] = Bh);
    (BBUF[2 * c + 1] = Cl), (BBUF[2 * c] = Ch);
    (BBUF[2 * d + 1] = Dl), (BBUF[2 * d] = Dh);
...
class Blake1_64 extends Blake1 {
    ...
    compress(view, offset, withLength = true) {
        ...
        if (withLength) {
            const { h, l } = (0, _u64_js_1.fromBig)(BigInt(this.length * 8));
            BBUF[24] = (BBUF[24] ^ h) >>> 0;
            BBUF[25] = (BBUF[25] ^ l) >>> 0;
            BBUF[26] = (BBUF[26] ^ h) >>> 0;
            BBUF[27] = (BBUF[27] ^ l) >>> 0;
...
class Blake256 extends Blake1_32 {
    constructor(opts = {}) {
        // == SHA256_IV
        super(32, blake2s_js_1.B2S_IV, 1, opts);
    }
}
...
exports.blake224 = (0, utils_js_1.wrapConstructorWithOpts)((opts) => new Blake224(opts));
/** blake1-256 hash function */
exports.blake256 = (0, utils_js_1.wrapConstructorWithOpts)((opts) => new Blake256(opts));
/** blake1-384 hash function */
exports.blake384 = (0, utils_js_1.wrapConstructorWithOpts)((opts) => new Blake384(opts));
/** blake1-512 hash function */
exports.blake512 = (0, utils_js_1.wrapConstructorWithOpts)((opts) => new Blake512(opts));
