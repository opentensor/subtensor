...
import { Hash, createView, toBytes, wrapConstructorWithOpts } from './utils.js';
...
export const blake224 = /* @__PURE__ */ wrapConstructorWithOpts((opts) => new Blake224(opts));
/** blake1-256 hash function */
export const blake256 = /* @__PURE__ */ wrapConstructorWithOpts((opts) => new Blake256(opts));
/** blake1-384 hash function */
export const blake384 = /* @__PURE__ */ wrapConstructorWithOpts((opts) => new Blake384(opts));
/** blake1-512 hash function */
export const blake512 = /* @__PURE__ */ wrapConstructorWithOpts((opts) => new Blake512(opts));
