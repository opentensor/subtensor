...
export type SignMessageParameters<account extends Account | undefined = Account | undefined, accountOverride extends Account | undefined = Account | undefined, verifier extends Address | undefined = Address | undefined> = Pick<GetEip712DomainParameters, 'factory' | 'factoryData'> & GetAccountParameter<account, accountOverride> & {
    message: SignableMessage;
} & OneOf<{
    verifierDomain: RequiredBy<TypedDataDomain, 'chainId' | 'name' | 'verifyingContract' | 'version'>;
    verifier?: undefined;
} | (GetVerifierParameter<verifier> & {
    verifierDomain?: RequiredBy<TypedDataDomain, 'chainId' | 'name' | 'verifyingContract' | 'version'> | undefined;
})>;
 ...
 * })
 */
export declare function signMessage<chain extends Chain | undefined, account extends Account | undefined, accountOverride extends Account | undefined = undefined>(client: Client<Transport, chain, account>, parameters: SignMessageParameters<account, accountOverride>): Promise<SignMessageReturnType>;
