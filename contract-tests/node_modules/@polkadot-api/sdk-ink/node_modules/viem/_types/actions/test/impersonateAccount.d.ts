 ...
 * })
 */
export declare function impersonateAccount<chain extends Chain | undefined, account extends Account | undefined>(client: TestClient<TestClientMode, Transport, chain, account, false>, { address }: ImpersonateAccountParameters): Promise<void>;
