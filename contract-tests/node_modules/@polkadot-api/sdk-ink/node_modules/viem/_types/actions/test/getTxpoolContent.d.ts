 ...
 */
export declare function getTxpoolContent<chain extends Chain | undefined, account extends Account | undefined>(client: TestClient<TestClientMode, Transport, chain, account, false>): Promise<GetTxpoolContentReturnType>;
