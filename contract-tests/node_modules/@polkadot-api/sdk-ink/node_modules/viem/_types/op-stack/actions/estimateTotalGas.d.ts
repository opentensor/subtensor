...
export type EstimateTotalGasParameters<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined, chainOverride extends Chain | undefined = Chain | undefined> = EstimateL1GasParameters<chain, account, chainOverride>;
 ...
 * })
 */
export declare function estimateTotalGas<chain extends Chain | undefined, account extends Account | undefined, chainOverride extends Chain | undefined = undefined>(client: Client<Transport, chain, account>, args: EstimateTotalGasParameters<chain, account, chainOverride>): Promise<EstimateTotalGasReturnType>;
