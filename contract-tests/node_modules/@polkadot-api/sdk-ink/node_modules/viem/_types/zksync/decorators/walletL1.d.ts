...
import { type ClaimFailedDepositParameters, type ClaimFailedDepositReturnType } from '../actions/claimFailedDeposit.js';
...
export type WalletActionsL1<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
     ...
     * })
     */
    claimFailedDeposit: <chainOverride extends Chain | undefined = undefined, chainL2 extends ChainEIP712 | undefined = ChainEIP712 | undefined, accountL2 extends Account | undefined = Account | undefined>(parameters: ClaimFailedDepositParameters<chain, account, chainOverride, chainL2, accountL2>) => Promise<ClaimFailedDepositReturnType>;
    /**
