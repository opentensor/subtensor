...
import { type GetGasPerPubdataReturnType } from '../actions/getGasPerPubdata.js';
...
export type PublicActionsL2<chain extends ChainEIP712 | undefined = ChainEIP712 | undefined, account extends Account | undefined = Account | undefined> = {
    /**
     ...
     */
    estimateFee: (args: EstimateFeeParameters<chain, account>) => Promise<EstimateFeeReturnType>;
    /**
     ...
     */
    estimateGasL1ToL2: (args: EstimateGasL1ToL2Parameters<chain, account>) => Promise<EstimateGasL1ToL2ReturnType>;
    /**
