...
export const IStakingV2ABI = [
  ...
  {
    inputs: [{ internalType: "bytes32", name: "coldkey", type: "bytes32" }],
  ...
  {
    inputs: [{ internalType: "bytes32", name: "hotkey", type: "bytes32" }],
