...
type FullGrandpaBlockImport<B, C> =
...
where
    ...
    BIQ: FnOnce(
        ...
        FullGrandpaBlockImport<B, FullClient<B, RA, HF>>,
        Arc<FullPool<B, FullClient<B, RA, HF>>>,
        FullSelectChain<B>,
    ) -> Result<
        (
            BasicQueue<B>,
...
pub fn build_aura_grandpa_import_queue<B, RA, HF>(
    ...
    grandpa_block_import: FullGrandpaBlockImport<B, FullClient<B, RA, HF>>,
...
//    grandpa_block_import: FullGrandpaBlockImport<B, FullClient<B, RA, HF>>,
//    _transaction_pool: Arc<FullPool<B, FullClient<B, RA, HF>>>,
//    _select_chain: FullSelectChain<B>,
    ...
    NB: sc_network::NetworkBackend<B, <B as sp_runtime::traits::Block>::Hash>,
{
    let build_import_queue = if sealing.is_some() {
        unimplemented!("Manual seal not supported yet")
