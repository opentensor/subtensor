    ...
    let mut balances = vec![
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5CPHQqL9E4GJLxeo7r61fqiQWE2xBgcsdKrLPyZpCKRHFWt8",
            )
        ...
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5Fuck5PH4Ug6iQpXhhNL2LvyUW4rVdi2ZRbZS6x8XV1SgNZ6",
            )
            .unwrap(), // josh | Manifold Labs [τ, ∆]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5HpE7oRTSbKZF1ZP3NEcDr4MnM1UpTmbGD61B7RNH8VdFQZd",
            )
            .unwrap(), // arvee [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5EvAf5fDX3jNkCg158ctDnHAb7JX34eXTtHRGdreQebyFhHz",
            )
            .unwrap(), // 0xBomb[τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5DktX2XnHZUSWmBk9nPmvE3XwH3e8WiUCNszXrVzKBtSNLC8",
            )
            .unwrap(), // yikesawjeez [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5GdhNRf6nqhybVTuzSCm4huRrh7W2PzHo1craMyrPttZQzKK",
            )
            .unwrap(), // HcL-CO | [η, ז]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5EgyK4xFAokjdYGMrWn1ikXrBBGRZyq5eoF5zMP35rGHs5hL",
            )
            .unwrap(), // hoτes [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5FyJK1gMCShmfGcnh12VG1cdHULaXoMx4qk5mWLpXhoEDjm4",
            )
            .unwrap(), // τaogon [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5Ca6zA5dH6h4DUnGt1ixvY5V8mWvKM3ATvuprCUjgEFqDay9",
            )
            .unwrap(), // Maciej Kula [𝞃, 𝞃]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5Ge3DKM155dLpvEFjFcgJ6c3RVcaQAL1EBWp8G7nJSBn8Aaq",
            )
        ...
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5EZSWFuFQB6Avs9y7NCVTkGRcUi5eBomrUfS1SmmR5H1paCU",
            )
            .unwrap(), // Don [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5GYnsEFDBoB3uaPu4LyeRrgvCsLLzsUvV5kiKGNF5Kbf72MV",
            )
        ...
        (
            ...
            .unwrap(), // Ashley | SN39 [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5HgxtsYn7euSLgZZVRV7BzL5voDpDQA4GojtyPKAatKGLZ7C",
            )
            .unwrap(), // benton [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5EUQ6C94Nyxa7WDwNKzMnwa3Jgqv8U2ZuergAF5oVWys3RFN",
            )
            .unwrap(), // boogie_man [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5Fba44AeMsz3jqa1zaenvbtwE5MKBEwiNbZ41spc22sQobSt",
            )
        ...
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5DXULyK6jUGDdRkfTLpZunkyZvzrKH8Wtyw39eosGs2nBU1R",
            )
        ...
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5EHH1MKy8vrMaJ6JzbWbdXzihPMqk25LueSaEgMn8bDgNc4t",
            )
            .unwrap(), // Colin [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5EEox4pimQK1aDNA3kPUGry1VWognkGY7WxSMrMXQmTKpxS7",
            )
            .unwrap(), // palmeidawrt [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5GKKGQfbtzELVuPgpoofwDFAzf4J92u6tsdN9NVCinsuzpdu",
            )
        ...
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5GsicYaRc3yUxQSgHavMnSuriwCPD92NERDNkvsmfnnfqXyi",
            )
            .unwrap(), // Volodymyr Truba[τ, τ]Macrocosmos
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5DeXR1sgZF1jE2vG7Jx8edsCr12LF4PtmScR1zSPMSzRrWCK",
            )
            .unwrap(), // taozen [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5DvjBoT5obrba9bemsiwgvCJd9gdx37xcS4w3iC9Ra5xP9JN",
            )
            .unwrap(), // Fel [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5E6tCDpY9jg25uCLTWHpDoK23UHpanes1PcTiB6dkNcB2FHb",
            )
            .unwrap(), // pylegend [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5FsC7s4txtDvneQUYoY2HFzGQEU9e5LbUGnEE5Jz2aLxKEbc",
            )
            .unwrap(), // Kao [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5DevrqGMa6ahKyRqk57qb3DTLZt29VZ8y6r14LgRRJgp5AcG",
            )
            .unwrap(), // Ciel [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5CPN27vJ6x6f16TESnMi6qPAunDDpze11ThCurRLXS3pDgss",
            )
            .unwrap(), // Alder [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5CarroqMMihUTGHcy46iAaaMYwsSZvmjmH69za4eTmYh2CJ4",
            )
        ...
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5G3fBbCmWcMygdy3oK3HyiDNSCZim3TvLguRxHfxg4U7TwQg",
            )
            .unwrap(), // UltraShiny [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5GYNpL3UuQej8bYQvXWSw5dQqmEmgJ4oJ51G9uvEeq42b2nS",
            )
            .unwrap(), // Vlad [τ, τ)
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5HNp2h9C4A4BWP42b1eKmjszUC335WaLCJdXkSSA8PYdUBMx",
            )
            .unwrap(), // X_Blazer [τ, ⛏]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5CLUM696NNNk8XtquxJCAvJ6S3FGDofZnZ3z8BUJKBcQYDCS",
            )
            .unwrap(), // EchoStorm [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5G3aQtA1ckoVCSgEWTbK6TFvMiQD6j8k4KoDA4iXcvVWH859",
            )
            .unwrap(), // 𝒜𝑒𝓉𝒽 [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5Dy7aZFuVqisdDAvKGyQq1JdNjd4XjZ1kCbutz16k6asLqnJ",
            )
            .unwrap(), // Buddy [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5Hgv9NxxFepLC1RZGGD2iosAtTh8NKwVrGUBEoT4TYb9zvMU",
            )
        ...
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5DEv67Dd7EXZEcpfSsPrSUVmHgBQmtrybTNPNdDov48CDCVU",
            )
            .unwrap(), // Professor [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5GRA4pktvTrDoVuMn8Xo1JCQC8CCJkVHtL1q2QTJ9gVhpcm3",
            )
            .unwrap(), // Platwsup  [τ,τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5Co51B3Po5uauyuby9WYHqTcEysVeJwyBTTuzPx98XUaBFso",
            )
            .unwrap(), // Waris | [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5D8Kiee7DBcSZGMKVYAadVxeJnh1MEaQaeSTF8GEu2ZJDa9w",
            )
            .unwrap(), // Freebird | Datura [τ, τ)
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5GvT34BeeL8Gjtw3kTjytYg3qE3mYJh2SPBDuKW4qgJKNTHa",
            )
            .unwrap(), // Cipher [τ , ⛏]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5CiCXcx8FEhWZHCLLJm8rtvsaubinZUnjcq8SaSeAekEkDAZ",
            )
            .unwrap(), // ADally [𝞃, 𝞃]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5FBitd8W9mr16bME3jPYxqZscKNFrQM5wZkPBXebmmhW3ZiX",
            )
            .unwrap(), // shahjab [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5Gumfmxcd9BkLVC5dE8ZqLyiS7yk4pE12C8EsR4684ZEfHBF",
            )
            .unwrap(), // mrbovo
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5ELAdQ1m24q4t13UYmSVuWj887iZSxF51hWztZjKNrp5t1pn",
            )
            .unwrap(), // Ailith (τ_τ)
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5HdctsgE4uoqvjywLMWyvaaR9b7JpXCAt8BuhcbkoeU8g1WW",
            )
            .unwrap(), // Echo | cortex.foundation [τ, с]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5FkFULMPhLBJFh2yDzeFSa6vtMm2a3ZK8B2RhsHSpszkVGPK",
            )
            .unwrap(), // CreativeEssence [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5Eh77jcKp6RoggfecBCEB5KEsPiX8XaW2kwgH6KPgXyBQm6J",
            )
            .unwrap(), // BτGuy | τ, ψ/ך
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5CML2G4gwAv3WLctozwivVTWW2Q1HHbszxWLEPM2o2e4KFeG",
            )
            .unwrap(), // prop_physics [τ, τ]
            100_000_000_000u128,
        ),
        (
            <AccountId32 as Ss58Codec>::from_ss58check(
                "5HgbfjJLUmoBJ78o1dc6ubZJ1nGA2kXzVrgTFhrSz7yUbftE",
            )
            .unwrap(), // Rhef
            100_000_000_000u128,
        ),
