...
impl SubnetPrecompile {
    pub fn execute(handle: &mut impl PrecompileHandle) -> PrecompileResult {
        ...
        log::warn!("========== precompile execute: method id = {:?}", method_id);
        ...
        match method_id {
            ...
            id if id == get_method_id("setServingRateLimit(uint256,uint256)") => {
    ...
    fn set_serving_rate_limit(handle: &mut impl PrecompileHandle, data: &[u8]) -> PrecompileResult {
        ...
        log::warn!("==========set_serving_rate_limit: netuid = {:?}, serving_rate_limit = {:?}", netuid, serving_rate_limit);
