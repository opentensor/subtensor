...
construct_runtime!(
    pub struct Runtime
    {
        ...
        Staking: pallet_staking = 27,
        Offences: pallet_offences = 28,
        Historical: session_historical = 29,
        Session: pallet_session = 30,
        AuthorityDiscovery: pallet_authority_discovery = 31,
        Babe: pallet_babe = 32,
        ElectionProviderMultiPhase: pallet_election_provider_multi_phase = 33,
        VoterList: pallet_bags_list::<Instance1> = 34,
        FastUnstake: pallet_fast_unstake = 35,
