...
use frame_support::{dispatch::{DispatchInfo, Pays}, RuntimeDebugNoBound};
...
use sp_runtime::{
    ...
    Weight,
    Saturating,
    traits::{DispatchInfoOf, Dispatchable, One, Zero, TransactionExtension, AsSystemOriginSigner, ValidateResult, PostDispatchInfoOf},
	...
	<T::RuntimeCall as Dispatchable>::RuntimeOrigin: AsSystemOriginSigner<T::AccountId> + Clone,
{
	...
	fn validate(
		...
		if info.pays_fee == Pays::Yes && account.providers.is_zero() && account.sufficients.is_zero() {
