...
const AUTHORIZED_PREFIXES: [[u8; 16]; 10] = [
    ...
    // twox_128("Multisig")
    [
        0x74, 0x74, 0x44, 0x9c, 0xca, 0x95, 0xdc, 0x5d, 0x0c, 0x00, 0xe7, 0x17, 0x35, 0xa6, 0xd1,
        0x7d,
    ],
    // twox_128("Timestamp")
    [
        0xf0, 0xc3, 0x65, 0xc3, 0xcf, 0x59, 0xd6, 0x71, 0xeb, 0x72, 0xda, 0x0e, 0x7a, 0x41, 0x13,
        0xc4,
    ],
];
