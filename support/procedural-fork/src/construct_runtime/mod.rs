...
fn construct_runtime_implicit_to_explicit(
    ...
    for pallet in definition
        .pallets
        .iter()
        .filter(|pallet| pallet.pallet_parts.is_none())
    {
...
fn construct_runtime_explicit_to_explicit_expanded(
    ...
    for pallet in definition
        .pallets
        .iter()
        .filter(|pallet| !pallet.is_expanded)
    {
        let pallet_path = &pallet.path;
        let pallet_name = &pallet.name;
        let pallet_instance = pallet
