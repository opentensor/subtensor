...
} from "../../ts-tests/utils/rate_limiting.ts";
...
export const SOURCE_CHAIN_SPEC = process.env.CLONE_CHAIN_SPEC || resolve(REPO_ROOT, "chainspecs/raw_spec_finney.json");
...
function getResponseKind(response: any): "grouped" | "standalone" | undefined {
    if (response && typeof response === "object") {
        ...
        if (response.type === "standalone" || response.type === "Standalone" || "Standalone" in response) {
            return "standalone";
        }
    ...
    try {
        ...
        const expectedGroupedCalls: Array<{
            ...
            { pallet: "SubtensorModule", extrinsic: "serve_prometheus", groupId: GROUP_SERVE, scopeKind: "scoped" },
            {
                ...
                extrinsic: "increase_take",
                groupId: GROUP_DELEGATE_TAKE,
                scopeKind: "global",
            },
            {
                pallet: "SubtensorModule",
                extrinsic: "decrease_take",
                groupId: GROUP_DELEGATE_TAKE,
                scopeKind: "global",
            },
            ...
            {
                pallet: "SubtensorModule",
                extrinsic: "batch_commit_weights",
                groupId: GROUP_WEIGHTS_SET,
                scopeKind: "scoped",
            },
            {
                pallet: "SubtensorModule",
                extrinsic: "commit_timelocked_weights",
                groupId: GROUP_WEIGHTS_SET,
                scopeKind: "scoped",
            },
            ...
            {
                pallet: "SubtensorModule",
                extrinsic: "batch_reveal_weights",
                groupId: GROUP_WEIGHTS_SET,
                scopeKind: "scoped",
            },
            {
                pallet: "SubtensorModule",
                extrinsic: "set_mechanism_weights",
                groupId: GROUP_WEIGHTS_SET,
                scopeKind: "scoped",
            },
            {
                pallet: "SubtensorModule",
                extrinsic: "commit_mechanism_weights",
                groupId: GROUP_WEIGHTS_SET,
                scopeKind: "scoped",
            },
            {
                pallet: "SubtensorModule",
                extrinsic: "commit_crv3_mechanism_weights",
                groupId: GROUP_WEIGHTS_SET,
                scopeKind: "scoped",
            },
            {
                pallet: "SubtensorModule",
                extrinsic: "commit_timelocked_mechanism_weights",
                groupId: GROUP_WEIGHTS_SET,
                scopeKind: "scoped",
            },
            {
                pallet: "SubtensorModule",
                extrinsic: "reveal_mechanism_weights",
                groupId: GROUP_WEIGHTS_SET,
                scopeKind: "scoped",
            },
            {
                pallet: "SubtensorModule",
                extrinsic: "register_network",
                groupId: GROUP_REGISTER_NETWORK,
                scopeKind: "global",
            },
            {
                pallet: "SubtensorModule",
                extrinsic: "register_network_with_identity",
                groupId: GROUP_REGISTER_NETWORK,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_serving_rate_limit",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_max_difficulty",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_adjustment_alpha",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_immunity_period",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_min_allowed_weights",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
            ...
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_activity_cutoff",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            ...
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_network_pow_registration_allowed",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            ...
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_bonds_moving_average",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_bonds_penalty",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_commit_reveal_weights_enabled",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
            ...
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_alpha_values",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_commit_reveal_weights_interval",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_toggle_transfer",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_alpha_sigmoid_steepness",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_yuma3_enabled",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_bonds_reset_enabled",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_owner_immune_neuron_limit",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_recycle_or_burn",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_burn_half_life",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            {
                pallet: "AdminUtils",
                extrinsic: "sudo_set_burn_increase_mult",
                groupId: GROUP_OWNER_HPARAMS,
                scopeKind: "global",
            },
            ...
            {
                pallet: "SubtensorModule",
                extrinsic: "add_stake_limit",
                groupId: GROUP_STAKING_OPS,
                scopeKind: "global",
            },
            { pallet: "SubtensorModule", extrinsic: "remove_stake", groupId: GROUP_STAKING_OPS, scopeKind: "global" },
            {
                pallet: "SubtensorModule",
                extrinsic: "remove_stake_limit",
                groupId: GROUP_STAKING_OPS,
                scopeKind: "global",
            },
            {
                pallet: "SubtensorModule",
                extrinsic: "remove_stake_full_limit",
                groupId: GROUP_STAKING_OPS,
                scopeKind: "global",
            },
...
export async function verifyCloneStorageAudit() {
    ...
    try {
        ...
        try {
            await api.query.RateLimiting.LastSeen.getValue(rateLimitTargetGroup(GROUP_SERVE) as never, undefined, {
                at: "best",
            });
        } catch (error) {
            const message = error instanceof Error ? error.message : String(error);
        ...
        for (const { keyArgs, value } of await api.query.SubtensorModule.LastRateLimitedBlock.getEntries({
            at: "best",
        })) {
...
async function sudoSetCommitRevealWeightsEnabled(api: TypedApi<typeof subtensor>, netuid: number, enabled: boolean) {
    const alice = getAlice();
...
async function sudoSetStakeThreshold(api: TypedApi<typeof subtensor>, minStake: number | bigint) {
    ...
    await waitForTransactionWithRetry(api, asSudoTx(api, inner) as any, alice as any, "sudo_set_stake_threshold");
}
...
async function sudoSetGlobalGroupRateLimit(api: TypedApi<typeof subtensor>, groupId: number, limit: number) {
    const alice = getAlice();
    const inner = api.tx.RateLimiting.set_rate_limit({
        target: rateLimitTargetGroup(groupId) as never,
        scope: undefined,
...
export async function verifyCloneBehavior(filter?: BehaviorPhase) {
    ...
    try {
        ...
        if (shouldRunPhase(filter, "delegate-take")) {
            ...
            await waitForFinalizedBlocks(api, 2);
            await waitForRateLimitTransactionWithRetry(api, increaseTake, coldkey, "clone_increase_take_after_window");
        }
        ...
        if (shouldRunPhase(filter, "owner-hparams")) {
            ...
            const cutoffAFirst = asSudoTx(
                api,
                api.tx.AdminUtils.sudo_set_activity_cutoff({
                    netuid: netuidOwnerA,
                    activity_cutoff: activityCutoffA + 1,
                })
            );
            const cutoffASecond = asSudoTx(
                api,
                api.tx.AdminUtils.sudo_set_activity_cutoff({
                    netuid: netuidOwnerA,
            ...
            const rhoACall = asSudoTx(
                api,
                api.tx.AdminUtils.sudo_set_rho({
                    netuid: netuidOwnerA,
                    rho: rhoA + 1,
                })
            );
            const cutoffB = asSudoTx(
                api,
                api.tx.AdminUtils.sudo_set_activity_cutoff({
                    netuid: netuidOwnerB,
            ...
            const burnHalfLifeFirst = asSudoTx(
                api,
                api.tx.AdminUtils.sudo_set_burn_half_life({
                    netuid: netuidOwnerA,
                    burn_half_life: 361,
                })
            );
            const burnHalfLifeSecond = asSudoTx(
                api,
                api.tx.AdminUtils.sudo_set_burn_half_life({
                    netuid: netuidOwnerA,
                    burn_half_life: 362,
            ...
            const burnIncreaseMult = asSudoTx(
                api,
                api.tx.AdminUtils.sudo_set_burn_increase_mult({
                    netuid: netuidOwnerA,
            ...
            await waitForFinalizedBlocks(api, 2);
            assert.equal(
                await api.query.SubtensorModule.ActivityCutoff.getValue(netuidOwnerA),
