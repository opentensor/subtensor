...
mod benchmarks {
	...
	{
		T::SubtensorModule::init_new_network(1u16/*netuid*/, 1u16/*tempo*/);
	...
	fn sudo_set_kappa()
	{
		T::SubtensorModule::init_new_network(1u16/*netuid*/, 1u16/*sudo_tempo*/);
	...
	/*
		...
		T::SubtensorModule::init_new_network(netuid, tempo);
