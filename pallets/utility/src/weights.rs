...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(18_058_507, 3983)
			// Standard Error: 2_296
			.saturating_add(Weight::from_parts(5_698_283, 0).saturating_mul(c.into()))
	...
	fn as_derivative() -> Weight {
		...
		Weight::from_parts(15_439_000, 3983)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	/// Storage: `SafeMode::EnteredUntil` (r:1 w:0)
	/// Proof: `SafeMode::EnteredUntil` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(16_601_600, 3983)
			// Standard Error: 2_173
			.saturating_add(Weight::from_parts(5_973_561, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	fn dispatch_as() -> Weight {
		// Proof Size summary in bytes:
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(17_947_766, 3983)
			// Standard Error: 2_310
			.saturating_add(Weight::from_parts(5_704_711, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	fn dispatch_as_fallible() -> Weight {
		// Proof Size summary in bytes:
	...
	fn if_else() -> Weight {
		...
		Weight::from_parts(22_092_000, 3983)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
}
