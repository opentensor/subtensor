...
pub use subtensor_runtime_common::{AlphaCurrency, ConstTao, Currency, NetUid, TaoCurrency};
...
parameter_types! {
    ...
    pub const InitialNetworkMinLockCost: TaoCurrency = TaoCurrency::new(100_000_000_000_u64);
