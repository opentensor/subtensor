...
pub use subtensor_runtime_common::{AlphaBalance, ConstTao, NetUid, TaoBalance, Token};
...
parameter_types! {
    ...
    pub const InitialNetworkMinLockCost: TaoBalance = TaoBalance::new(100_000_000_000_u64);
