...
impl<T: Config> Pallet<T> {
    ...
    pub fn epoch_mock(netuid: u16, rao_emission: u64) -> Vec<(T::AccountId, u64, u64)> {
        ...
        Rank::<T>::insert(netuid, vec![0u16; n as usize]);
        Trust::<T>::insert(netuid, vec![0u16; n as usize]);
        Consensus::<T>::insert(netuid, vec![0u16; n as usize]);
        Incentive::<T>::insert(netuid, vec![0u16; n as usize]);
        Dividends::<T>::insert(netuid, vec![0u16; n as usize]);
