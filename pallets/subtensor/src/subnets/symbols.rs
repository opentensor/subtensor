...
pub static SYMBOLS: [&[u8]; 439] = [
    ...
    b"\xE1\x9A\xB3", // ᚲ (Kaunan, ulcer, 86)
    ...
    b"\xE1\x84\x82", // ㄷ (Digeut, 213)
    b"\xE1\x84\x83", // ㄹ (Rieul, 214)
    b"\xE1\x84\x84", // ㅁ (Mieum, 215)
    b"\xE1\x84\x85", // ㅂ (Bieup, 216)
    b"\xE1\x84\x86", // ㅅ (Siot, 217)
    b"\xE1\x84\x87", // ㅇ (Ieung, 218)
    b"\xE1\x84\x88", // ㅈ (Jieut, 219)
    b"\xE1\x84\x89", // ㅊ (Chieut, 220)
    b"\xE1\x84\x8A", // ㅋ (Kieuk, 221)
    ...
    b"\xE1\x85\xA3", // ㅑ (Ya, 227)
    b"\xE1\x85\xA4", // ㅒ (Yae, 228)
    b"\xE1\x85\xA5", // ㅓ (Eo, 229)
    b"\xE1\x85\xA6", // ㅔ (E, 230)
    b"\xE1\x85\xA7", // ㅕ (Yeo, 231)
    b"\xE1\x85\xA8", // ㅖ (Ye, 232)
    b"\xE1\x85\xA9", // ㅗ (O, 233)
    b"\xE1\x85\xAA", // ㅘ (Wa, 234)
    b"\xE1\x85\xAB", // ㅙ (Wae, 235)
    b"\xE1\x85\xAC", // ㅚ (Oe, 236)
    b"\xE1\x85\xAD", // ㅛ (Yo, 237)
    b"\xE1\x85\xAE", // ㅜ (U, 238)
    b"\xE1\x85\xAF", // ㅝ (Weo, 239)
    b"\xE1\x85\xB0", // ㅞ (We, 240)
    b"\xE1\x85\xB1", // ㅟ (Wi, 241)
    b"\xE1\x85\xB2", // ㅠ (Yu, 242)
    ...
    b"\xE1\x8A\x90", // ጐ (Go, 268)
    b"\xE1\x8A\x91", // ጑ (Gu, 269)
    b"\xE1\x8A\x92", // ጒ (Gi, 270)
    b"\xE1\x8A\x93", // መ (Gua, 271)
    ...
    b"\xE0\xB6\x87", // ඉ (I, 403)
    b"\xE0\xB6\x88", // ඊ (Ii, 404)
    b"\xE0\xB6\x89", // උ (U, 405)
    b"\xE0\xB6\x8A", // ඌ (Uu, 406)
    b"\xE0\xB6\x8B", // ඍ (R, 407)
    b"\xE0\xB6\x8C", // ඎ (Rr, 408)
    ...
    b"\xE0\xB6\x9F", // ච (Cha, 422)
    b"\xE0\xB6\xA0", // ඡ (Chha, 423)
    b"\xE0\xB6\xA1", // ජ (Ja, 424)
    b"\xE0\xB6\xA2", // ඣ (Jha, 425)
    b"\xE0\xB6\xA3", // ඤ (Nya, 426)
