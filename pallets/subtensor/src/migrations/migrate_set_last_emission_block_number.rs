...
pub fn migrate_set_last_emission_block_number<T: Config>() -> Weight {
    let migration_name = b"migrate_set_last_emission_block_number".to_vec();
    ...
    // ------------------------------
    // Step 1: Set the last emission block for all subnets except root
    // ------------------------------
