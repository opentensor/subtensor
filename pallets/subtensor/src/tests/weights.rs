...
use super::mock::*;
use crate::{coinbase::run_coinbase::WeightsTlockPayload, CRV3WeightCommits, Error, Owner};
...
fn test_reveal_crv3_commits_success() {
    new_test_ext(100).execute_with(|| {
        ...
        SubtensorModule::set_crv3_weights_enabled(netuid, true);
...
fn test_do_commit_crv3_weights_disabled() {
    new_test_ext(1).execute_with(|| {
        ...
        SubtensorModule::set_crv3_weights_enabled(netuid, false);
        assert_err!(
            ...
            Error::<Test>::CommitRevealV3Disabled
        );
    });
}
