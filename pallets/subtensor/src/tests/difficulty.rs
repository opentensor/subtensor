...
fn test_registration_difficulty_adjustment() {
    new_test_ext(1).execute_with(|| {
        ...
        println!(
            "Network parameters set. Registration allowed: {}",
        ...
        println!(
            "Registrations this block: {}",
            SubtensorModule::get_registrations_this_block(netuid)
        );
        println!(
            "Registrations this interval: {}",
            SubtensorModule::get_registrations_this_interval(netuid)
        );
        ...
        println!(
            "Last adjustment block: {}",
            SubtensorModule::get_last_adjustment_block(netuid)
        );
        println!(
            "New difficulty: {}",
            SubtensorModule::get_difficulty_as_u64(netuid)
        ...
        println!(
            "Set target registrations per interval to: {}",
            SubtensorModule::get_target_registrations_per_interval(netuid)
        );
        assert_eq!(
            SubtensorModule::get_target_registrations_per_interval(netuid),
        ...
        step_block(1); // Step
        println!(
            "Stepped 1 more block. New difficulty: {}",
            SubtensorModule::get_difficulty_as_u64(netuid)
        );
        println!(
            "Registrations this interval: {}",
        ...
        step_block(1); // Step
        println!(
            "Stepped 1 block. New difficulty: {}",
            SubtensorModule::get_difficulty_as_u64(netuid)
        );
