...
fn test_add_stake_partial_below_min_stake_fails() {
    new_test_ext(1).execute_with(|| {
        ...
        SubtensorModule::add_balance_to_coldkey_account(
            &coldkey_account_id,
            TaoCurrency::from(amount) + ExistentialDeposit::get(),
        );
...
fn test_get_alpha_share_stake_multiple_delegators() {
    new_test_ext(1).execute_with(|| {
        ...
        let existential_deposit = TaoCurrency::from(2);
...
fn test_add_stake_fee_goes_to_subnet_tao() {
    new_test_ext(1).execute_with(|| {
        ...
        let expected_alpha = AlphaCurrency::from((tao_to_stake - existential_deposit).to_u64());
        let actual_alpha =
...
fn test_remove_stake_fee_realistic_values() {
    new_test_ext(1).execute_with(|| {
        ...
        let hotkey = U256::from(2);
        let coldkey = U256::from(3);
        let alpha_to_unstake = AlphaCurrency::from(111_180_000_000_u64);
    ...
    new_test_ext(0).execute_with(|| {
        ...
        assert_eq!(
            SubtensorModule::get_max_amount_move(
                stable_netuid,
                dynamic_netuid,
                TaoCurrency::from(3_000_000_000_u64)
            ),
...
fn test_add_stake_limit_ok() {
    new_test_ext(1).execute_with(|| {
        ...
        let limit_price = TaoCurrency::from(24_000_000_000_u64);
        let expected_executed_stake = AlphaCurrency::from(75_000_000_000_u64);
...
fn test_add_stake_limit_fill_or_kill() {
    new_test_ext(1).execute_with(|| {
        ...
        let amount_ok = TaoCurrency::from(450_000_000_000_u64); // fits the maximum
        assert_ok!(SubtensorModule::add_stake_limit(
            RuntimeOrigin::signed(coldkey_account_id),
            hotkey_account_id,
            netuid,
...
fn test_add_stake_limit_partial_zero_max_stake_amount_error() {
    new_test_ext(1).execute_with(|| {
        ...
        let tao_reserve = TaoCurrency::from(5_032_494_439_940_u64);
        let alpha_in = AlphaCurrency::from(186_268_425_402_874_u64);
...
fn test_remove_stake_limit_ok() {
    new_test_ext(1).execute_with(|| {
        let hotkey_account_id = U256::from(533453);
        let coldkey_account_id = U256::from(55453);
        let stake_amount = TaoCurrency::from(300_000_000_000_u64);
...
fn test_remove_stake_limit_fill_or_kill() {
    new_test_ext(1).execute_with(|| {
        let hotkey_account_id = U256::from(533453);
        let coldkey_account_id = U256::from(55453);
        let stake_amount = AlphaCurrency::from(300_000_000_000_u64);
        let unstake_amount = AlphaCurrency::from(150_000_000_000_u64);
...
fn test_move_stake_limit_partial() {
    new_test_ext(1).execute_with(|| {
        ...
        let hotkey = U256::from(2);
        let stake_amount = AlphaCurrency::from(150_000_000_000_u64);
        let move_amount = AlphaCurrency::from(150_000_000_000_u64);
        ...
        assert_abs_diff_eq!(
            new_alpha,
            AlphaCurrency::from(149_000_000_000_u64),
...
fn test_unstake_all_hits_liquidity_min() {
    new_test_ext(1).execute_with(|| {
        ...
        let stake_amount = AlphaCurrency::from(190_000_000_000_u64); // 190 Alpha
...
fn test_unstake_all_alpha_hits_liquidity_min() {
    new_test_ext(1).execute_with(|| {
        ...
        let stake_amount = TaoCurrency::from(100_000_000_000_u64); // 100 TAO
...
fn test_unstake_all_alpha_works() {
    new_test_ext(1).execute_with(|| {
        ...
        let stake_amount = TaoCurrency::from(190_000_000_000_u64); // 190 TAO
...
fn test_swap_fees_tao_correctness() {
    new_test_ext(1).execute_with(|| {
        ...
        let owner_coldkey = U256::from(2);
        let coldkey = U256::from(4);
        let amount = TaoCurrency::from(1_000_000_000_u64);
        ...
        let tao_reserve = TaoCurrency::from(100_000_000_000_u64);
        let alpha_in = AlphaCurrency::from(400_000_000_000_u64);
        mock::setup_reserves(netuid, tao_reserve, alpha_in);
        ...
        let mut fees = (fee_rate * u64::from(amount) as f64) as u64;
        ...
        fees += (fee_rate * u64::from(amount) as f64) as u64;
...
fn test_remove_stake_full_limit_ok() {
    new_test_ext(1).execute_with(|| {
        ...
        let stake_amount = AlphaCurrency::from(10_000_000_000_u64);
...
fn test_remove_stake_full_limit_fails_slippage_too_high() {
    new_test_ext(1).execute_with(|| {
        ...
        let invalid_limit_price = TaoCurrency::from(910_000_000_u64);
...
fn test_default_min_stake_sufficiency() {
    new_test_ext(1).execute_with(|| {
        ...
        // 1% of TAO max supply
        // 0.01 Alpha price
        let tao_reserve = TaoCurrency::from(210_000_000_000_000_u64);
        let alpha_in = AlphaCurrency::from(21_000_000_000_000_000_u64);
        mock::setup_reserves(netuid, tao_reserve, alpha_in);
...
fn test_large_swap() {
    new_test_ext(1).execute_with(|| {
        ...
        let swap_amount = TaoCurrency::from(100_000_000_000_000_u64);
        assert_ok!(SubtensorModule::add_stake(
            RuntimeOrigin::signed(coldkey),
            owner_hotkey,
            netuid,
    ...
    new_test_ext(0).execute_with(|| {
        ...
        assert_err!(
            SubtensorModule::remove_stake(
                ...
                hot1,
                netuid,
                AlphaCurrency::from(amount.to_u64())
            ),
...
fn test_add_root_updates_counters() {
    new_test_ext(0).execute_with(|| {
        ...
        let stake_amount = TaoCurrency::from(1_000_000_000_u64);
        ...
        SubnetAlphaIn::<Test>::insert(NetUid::ROOT, AlphaCurrency::from(stake_amount.to_u64()));
...
fn test_remove_root_updates_counters() {
    new_test_ext(0).execute_with(|| {
        ...
        let stake_amount = TaoCurrency::from(1_000_000_000);
        ...
        SubnetAlphaOut::<Test>::insert(NetUid::ROOT, AlphaCurrency::from(stake_amount.to_u64()));
