...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Proof: `SubtensorModule::OwnedHotkeys` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `SubtensorModule::AutoStakeDestination` (r:512 w:0)
	/// Proof: `SubtensorModule::AutoStakeDestination` (`max_values`: None, `max_size`: None, mode: `Measured`)
	...
	fn terminate_lease(k: u32, ) -> Weight {
		...
		// Minimum execution time: 114_944_000 picoseconds.
		Weight::from_parts(127_584_134, 6148)
			// Standard Error: 9_594
			.saturating_add(Weight::from_parts(1_513_931, 0).saturating_mul(k.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
