...
mod events {
    ...
    pub enum Event<T: Config> {
        ...
        AggregatedStakeAdded(T::AccountId, T::AccountId, NetUid, u64),
        /// adding aggregated stake has failed
        FailedToAddAggregatedStake(T::AccountId, T::AccountId, NetUid, u64),
        /// limited stake has been transferred from the coldkey account onto the hotkey staking account (at the end of the block)
        AggregatedLimitedStakeAdded(T::AccountId, T::AccountId, NetUid, u64, u64, bool),
        /// adding limited aggregated stake has failed
        FailedToAddAggregatedLimitedStake(T::AccountId, T::AccountId, NetUid, u64, u64, bool),
        /// stake has been removed from the hotkey staking account into the coldkey account (at the end of the block).
        AggregatedStakeRemoved(T::AccountId, T::AccountId, NetUid, u64),
        /// removing aggregated stake has failed
        FailedToRemoveAggregatedStake(T::AccountId, T::AccountId, NetUid, u64),
        ...
        AggregatedLimitedStakeRemoved(T::AccountId, T::AccountId, NetUid, u64, u64, bool),
        /// removing limited aggregated stake has failed
        FailedToRemoveAggregatedLimitedStake(T::AccountId, T::AccountId, NetUid, u64, u64, bool),
