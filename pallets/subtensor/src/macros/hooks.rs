    ...
    impl<T: Config> Hooks<BlockNumberFor<T>> for Pallet<T> {
        ...
        fn on_runtime_upgrade() -> frame_support::weights::Weight {
            ...
            weight = weight
                ...
                // Re-key AddStakeBurn rate limits by subnet and signer.
                .saturating_add(migrations::migrate_add_stake_burn_rate_limit_key::migrate_add_stake_burn_rate_limit_key::<T>())
