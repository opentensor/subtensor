...
mod dispatches {
    ...
    impl<T: Config> Pallet<T> {
        ...
        ///
        #[pallet::call_index(8)]
        #[pallet::weight((Weight::from_parts(1_953_000, 0)
        ...
        #[pallet::weight((Weight::from_parts(21_550_000, 0)
        .saturating_add(T::DbWeight::get().reads(6))
        ...
        #[pallet::weight((Weight::from_parts(276_100_000, 0)
        ...
        #[pallet::weight((Weight::from_parts(314_300_000, 10142)
        ...
        #[pallet::weight((
            Weight::from_parts(19_230_000, 0).saturating_add(T::DbWeight::get().reads_writes(4, 1)),
            DispatchClass::Operational,
            Pays::Yes
        ))]
