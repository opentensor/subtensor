...
impl<T: Config> Pallet<T> {
    pub fn run_coinbase(block_emission: U96F32) {
        ...
        for netuid_i in subnets_to_emit_to.iter() {
            ...
            let mut default_tao_in_i: U96F32 = block_emission
            ...
            let tao_in_i: U96F32;
            let tao_in_ratio: U96F32 = default_tao_in_i.safe_div_or(U96F32::saturating_from_num(block_emission), U96F32::saturating_from_num(0.0) );
            if price_i < tao_in_ratio {
                tao_in_i = price.saturating_mul( U96F32::saturating_from_num(block_emission) );
                alpha_in_i = alpha_emission_i;
                let difference_tao: U96F32 = default_tao_in_i.saturating_sub( tao_in_i );
                // Difference becomes buy.
                let bought_alpha: u64 = Self::swap_tao_for_alpha(
                    *netuid_i,
