...
fn test_registration_difficulty_adjustment() {
    new_test_ext(1).execute_with(|| {
        ...
        println!("Initial difficulty set to: {}", SubtensorModule::get_difficulty_as_u64(netuid));
        ...
        println!("Network parameters set. Registration allowed: {}", SubtensorModule::get_network_registration_allowed(netuid));
        ...
        println!("Updated network parameters:");
        println!("Difficulty: {}", SubtensorModule::get_difficulty_as_u64(netuid));
        println!("Adjustment interval: {}", SubtensorModule::get_adjustment_interval(netuid));
        println!("Target registrations per interval: {}", SubtensorModule::get_target_registrations_per_interval(netuid));
        println!("Max registrations per block: {}", SubtensorModule::get_max_registrations_per_block(netuid));
        println!("Max allowed UIDs: {}", SubtensorModule::get_max_allowed_uids(netuid));
        println!("Network registration allowed: {}", SubtensorModule::get_network_registration_allowed(netuid));
        ...
        println!("Registered 3 neurons. Checking UIDs...");
        assert_eq!(
        ...
        println!("Subnetwork size: {}", SubtensorModule::get_subnetwork_n(netuid));
        println!("Registrations this block: {}", SubtensorModule::get_registrations_this_block(netuid));
        println!("Registrations this interval: {}", SubtensorModule::get_registrations_this_interval(netuid));
        ...
        println!("Difficulty before block step: {}", SubtensorModule::get_difficulty_as_u64(netuid));
        assert_eq!(SubtensorModule::get_difficulty_as_u64(netuid), 20000); // Difficulty is unchanged.
        step_block(1);
        println!("Stepped 1 block. New state:");
        println!("Registrations this block: {}", SubtensorModule::get_registrations_this_block(netuid));
        println!("Last adjustment block: {}", SubtensorModule::get_last_adjustment_block(netuid));
        println!("New difficulty: {}", SubtensorModule::get_difficulty_as_u64(netuid));
        println!("Registrations this interval: {}", SubtensorModule::get_registrations_this_interval(netuid));
        ...
        println!("Set adjustment interval to: {}", SubtensorModule::get_adjustment_interval(netuid));
        ...
        println!("Set target registrations per interval to: {}", SubtensorModule::get_target_registrations_per_interval(netuid));
        assert_eq!(
            SubtensorModule::get_target_registrations_per_interval(netuid),
            3
        ); // Target is default.
        ...
        println!("Registered 3 more neurons. Checking UIDs...");
        assert_eq!(
            SubtensorModule::get_hotkey_for_net_and_uid(netuid, 0).unwrap(),
            hotkey0 + 1
        ); // replace 0
        ...
        println!("Registered 3 more neurons.");
        println!("Registrations this block: {}", SubtensorModule::get_registrations_this_block(netuid));
        assert_eq!(SubtensorModule::get_registrations_this_block(netuid), 3); // Registrations have been erased.
        ...
        println!("Stepped 1 block. New state:");
        println!("Registrations this interval: {}", SubtensorModule::get_registrations_this_interval(netuid));
        println!("Current difficulty: {}", SubtensorModule::get_difficulty_as_u64(netuid));
        ...
        step_block(1); // Step
        println!("Stepped 1 more block. New difficulty: {}", SubtensorModule::get_difficulty_as_u64(netuid));
        println!("Registrations this interval: {}", SubtensorModule::get_registrations_this_interval(netuid));
        ...
        println!("Set min difficulty to 1 and current difficulty to 4");
        assert_eq!(SubtensorModule::get_min_difficulty(netuid), 1);
        assert_eq!(SubtensorModule::get_difficulty_as_u64(netuid), 4);
        SubtensorModule::set_adjustment_interval(netuid, 1);
        step_block(1); // Step
        println!("Stepped 1 block. New difficulty: {}", SubtensorModule::get_difficulty_as_u64(netuid));
        ...
        println!("Set max difficulty to 10000 and current difficulty to 5000");
        ...
        println!("Registered 4 more neurons.");
        println!("Registrations this interval: {}", SubtensorModule::get_registrations_this_interval(netuid));
        println!("Target registrations per interval: {}", SubtensorModule::get_target_registrations_per_interval(netuid));
