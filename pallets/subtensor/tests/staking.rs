...
fn test_different_subnet_take_different_distribution() {
    new_test_ext(1).execute_with(|| {
        ...
        // Add balances.
        SubtensorModule::add_balance_to_coldkey_account(&coldkey0, 100000000000000u64);
        SubtensorModule::add_balance_to_coldkey_account(&coldkey1, 100000000000000u64);

        // Register the 2 neurons to new networks.
        let lock_cost_1 = SubtensorModule::get_network_lock_cost();
        user_add_network(coldkey0, hotkey0, 1);
        let lock_cost_2 = SubtensorModule::get_network_lock_cost();
        user_add_network(coldkey0, hotkey0, 2);

        // The tests below assume lock costs of LC1 = 100 and LC2 = 200
        assert_eq!(lock_cost_1, 100_000_000_000);
        assert_eq!(lock_cost_2, 200_000_000_000);

        // SubStake (Alpha balance)
        //   Subnet 1, cold0, hot0: LC1     (100)
        //   Subnet 2, cold0, hot0: LC2 * 2 (400)
        //
        ...
        //   Subnet 2: LC2 * 2
        //
        assert_substake(&coldkey0, &hotkey0, netuid1, 100_000_000_000);
        assert_substake(&coldkey0, &hotkey0, netuid2, 400_000_000_000);
        ...
        assert_eq!(SubtensorModule::get_alpha_reserve(netuid2), 400_000_000_000);
        ...
        //  What happens in add_subnet_stake >> compute_dynamic_stake:
        //    1. TAO Reserve gets increased by 100
        //    2. K = AlphaRes * TAORes
        //    3. NewAlphaReserve = K / (OldTaoReserve + 100)
        //    4. SubStake is increased by OldAlphaReserve - NewAlphaReserve
        //
        // SubStake (get_subnet_stake_for_coldkey_and_hotkey) assertions
        // LC1 is lock_cost_1, LC2 is lock_cost_2,
        //
        // DynamicTAOReserve (get_tao_reserve) assertions
        //   Subnet 1: LC1 + 100 = 200
        //   Subnet 2: LC2 + 100 = 300
        //
        // DynamicAlphaReserve (get_alpha_reserve) assertions
        //   Subnet 1: LC1 * LC1 / (LC1 + 100) = 50
        //   Subnet 2: LC2 * LC2 * 2 / (LC2 + 100) = 133
        //             200 * 200 * 2 / (200 + 100) = 266
        //
        // SubStake (Alpha balance)
        //   Subnet 1, cold0, hot0: 100 + 100 - 50 = 150
        //   Subnet 2, cold0, hot0: 400 + 400 - 266 = 534
        //
        assert_eq!(SubtensorModule::get_tao_reserve(netuid1), 200_000_000_000);
        assert_eq!(SubtensorModule::get_tao_reserve(netuid2), 300_000_000_000);
        assert_eq!(SubtensorModule::get_alpha_reserve(netuid1), 50_000_000_000);
        assert_eq!(SubtensorModule::get_alpha_reserve(netuid2), 266_666_666_666);
        assert_substake(&coldkey0, &hotkey0, netuid1, 150_000_000_000);
        assert_substake(&coldkey0, &hotkey0, netuid2, 533_333_333_334);
        ...
        //
        // DynamicTAOReserve (get_tao_reserve) assertions
        //   Subnet 1: 200 + 100 = 300
        //   Subnet 2: 300 + 100 = 400
        //
        // DynamicAlphaReserve (get_alpha_reserve) assertions
        //   Subnet 1: 50 * 200 / (200 + 100) = 33
        //   Subnet 2: 266 * 200 / (300 + 100) = 133
        //
        // SubStake (Alpha balance)
        //   Subnet 1, cold0, hot0: 100 + 100 - 50 = 150
        //             cold1, hot0: 50 - 33 = 17
        //   Subnet 2, cold0, hot0: 400 + 400 - 266 = 534
        //             cold1, hot0: 266 - 133 = 133
        //
        //  TODO: This test is expected to break until we calculate K dynamically in compute_dynamic_stake
        //
        assert_eq!(SubtensorModule::get_tao_reserve(netuid1), 300_000_000_000);
        assert_eq!(SubtensorModule::get_tao_reserve(netuid2), 400_000_000_000);
        assert_eq!(SubtensorModule::get_alpha_reserve(netuid1), 33_333_333_333);
        // assert_eq!(SubtensorModule::get_alpha_reserve(netuid2), 133_333_333_333); // ???
        assert_substake(&coldkey0, &hotkey0, netuid1, 150_000_000_000);
        assert_substake(&coldkey1, &hotkey0, netuid1, 16_666_666_667);
        assert_substake(&coldkey0, &hotkey0, netuid2, 533_333_333_334);
        // assert_substake(&coldkey1, &hotkey0, netuid2, 133_333_333_334); // ???
        ...
        // //
        // // DynamicTAOReserve (get_tao_reserve) assertions
        // //   Subnet 1: lock_cost_1
        // //   Subnet 2: lock_cost_2
        // //
        // // DynamicAlphaReserve (get_alpha_reserve) assertions
        // //   Subnet 1: lock_cost_1
        // //   Subnet 2: lock_cost_2 * 2
        // //
        // assert_substake(&coldkey0, &hotkey0, netuid1, 100_000_000_000);
        // assert_substake(&coldkey0, &hotkey1, netuid1, 0);
        // assert_substake(&coldkey1, &hotkey0, netuid1, 100_000_000_000);
        // assert_substake(&coldkey1, &hotkey1, netuid1, 0);
        // assert_substake(&coldkey0, &hotkey0, netuid2, 100_000_000_000);
        // assert_substake(&coldkey0, &hotkey1, netuid2, 0);
        // assert_substake(&coldkey1, &hotkey0, netuid2, 100_000_000_000);
        // assert_substake(&coldkey1, &hotkey1, netuid2, 0);


        // // assert_eq!(SubtensorModule::get_coldkey_hotkey_global_dynamic_tao(&coldkey0, &hotkey0), );
