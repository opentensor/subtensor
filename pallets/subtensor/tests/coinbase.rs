...
// when necesarry.
// SKIP_WASM_BUILD=1 RUST_LOG=debug cargo test --test coinbase test_adjust_registration_terms_for_networks_pow_difficulty_increase -- --nocapture
#[test]
fn test_adjust_registration_terms_for_networks_pow_difficulty_increase() {
...
// when necesarry.
// SKIP_WASM_BUILD=1 RUST_LOG=debug cargo test --test coinbase test_adjust_registration_terms_for_networks_burn_cost_increase -- --nocapture
#[test]
fn test_adjust_registration_terms_for_networks_burn_cost_increase() {
    new_test_ext(100).execute_with(|| {
        // Setup interval reached
        let netuid = 1;
        add_network(netuid, 1, 0);
...
// when necesarry.
// SKIP_WASM_BUILD=1 RUST_LOG=debug cargo test --test coinbase test_adjust_registration_terms_for_networks_pow_difficulty_and_burn_cost_increase -- --nocapture
#[test]
fn test_adjust_registration_terms_for_networks_pow_difficulty_and_burn_cost_increase() {
    new_test_ext(100).execute_with(|| {
        // Setup interval reached
        let netuid = 1;
        add_network(netuid, 1, 0);
...
// SKIP_WASM_BUILD=1 RUST_LOG=debug cargo test --test coinbase test_adjust_registration_terms_for_networks_pow_difficulty_and_burn_cost_increase -- --nocapture
#[test]
fn test_adjust_registration_terms_for_networks_burn_cost_decrease() {
    new_test_ext(100).execute_with(|| {
        // Setup interval reached
        let netuid = 1;
        add_network(netuid, 1, 0);
...
// when necesarry.
// SKIP_WASM_BUILD=1 RUST_LOG=debug cargo test --test coinbase test_adjust_registration_terms_for_networks_pow_difficulty_decrease -- --nocapture
#[test]
fn test_adjust_registration_terms_for_networks_pow_difficulty_decrease() {
    new_test_ext(100).execute_with(|| {
        // Setup interval reached
        let netuid = 1;
        add_network(netuid, 1, 0);
...
// SKIP_WASM_BUILD=1 RUST_LOG=debug cargo test --test coinbase test_adjust_registration_terms_for_networks_pow_difficulty_and_burn_cost_decrease -- --nocapture
#[test]
fn test_adjust_registration_terms_for_networks_pow_difficulty_and_burn_cost_decrease() {
    new_test_ext(100).execute_with(|| {
        // Setup interval reached
        let netuid = 1;
        add_network(netuid, 1, 0);
...
// SKIP_WASM_BUILD=1 RUST_LOG=debug cargo test --test coinbase test_adjust_registration_terms_for_networks_network_counters_drained_on_interval_reached -- --nocapture
#[test]
fn test_adjust_registration_terms_for_networks_network_counters_drained_on_interval_reached() {
    new_test_ext(100).execute_with(|| {
        // Setup interval reached
        let netuid = 1;
        add_network(netuid, 1, 0);
...
// SKIP_WASM_BUILD=1 RUST_LOG=debug cargo test --test coinbase test_adjust_registration_terms_for_networks_network_counters_not_drained_when_interval_not_reached -- --nocapture
#[test]
fn test_adjust_registration_terms_for_networks_network_counters_not_drained_when_interval_not_reached(
) {
    new_test_ext(100).execute_with(|| {
        // Setup interval reached
        let netuid = 1;
