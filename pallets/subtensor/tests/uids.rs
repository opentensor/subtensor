...
//         assert_eq!(
//             pallet_subtensor::Alpha::<Test>::get((hotkey_account_id, coldkey_account_id, netuid)),
//             stake_amount
//         );
//         assert_eq!(
//             pallet_subtensor::Alpha::<Test>::get((hotkey_account_id, coldkey_account1_id, netuid)),
//             stake_amount + 1
//         );
//         assert_eq!(
//             pallet_subtensor::Alpha::<Test>::get((hotkey_account_id, coldkey_account2_id, netuid)),
//             stake_amount + 2
//         );
