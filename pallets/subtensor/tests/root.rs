...
#[test]
fn test_error_vec_order_and_u8_conversion() {
    new_test_ext(1).execute_with(|| {
        let reference_errors = vec![
        ...
        assert!(Error::<()>::get_all_errors_as_vec() == reference_errors);

        for (i, error) in reference_errors.into_iter().enumerate() {
            assert_eq!(u8::from(error), i as u8);
        }
    });
}

#[test]
fn test_intentional_pallet_errors_modification() {
    new_test_ext(1).execute_with(|| {
        // This test is meant to ensure compile-time coverage
        // for changes to subtensor pallet errors.
        match Error::InvalidChild::<Test> {
            Error::SubNetworkDoesNotExist => 0,
            Error::RootNetworkDoesNotExist => 1,
            Error::InvalidIpType => 2,
            Error::InvalidIpAddress => 3,
            Error::InvalidPort => 4,
            Error::HotKeyNotRegisteredInSubNet => 5,
            Error::HotKeyAccountNotExists => 6,
            Error::HotKeyNotRegisteredInNetwork => 7,
            Error::NonAssociatedColdKey => 8,
            Error::HotKeyNotDelegateAndSignerNotOwnHotKey => 9,
            Error::StakeToWithdrawIsZero => 10,
            Error::NotEnoughStakeToWithdraw => 11,
            Error::NotEnoughStakeToSetWeights => 12,
            Error::NotEnoughBalanceToStake => 13,
            Error::BalanceWithdrawalError => 14,
            Error::ZeroBalanceAfterWithdrawn => 15,
            Error::NeuronNoValidatorPermit => 16,
            Error::WeightVecNotEqualSize => 17,
            Error::DuplicateUids => 18,
            Error::UidVecContainInvalidOne => 19,
            Error::WeightVecLengthIsLow => 20,
            Error::TooManyRegistrationsThisBlock => 21,
            Error::HotKeyAlreadyRegisteredInSubNet => 22,
            Error::NewHotKeyIsSameWithOld => 23,
            Error::InvalidWorkBlock => 24,
            Error::InvalidDifficulty => 25,
            Error::InvalidSeal => 26,
            Error::MaxWeightExceeded => 27,
            Error::HotKeyAlreadyDelegate => 28,
            Error::SettingWeightsTooFast => 29,
            Error::IncorrectWeightVersionKey => 30,
            Error::ServingRateLimitExceeded => 31,
            Error::UidsLengthExceedUidsInSubNet => 32,
            Error::NetworkTxRateLimitExceeded => 33,
            Error::DelegateTxRateLimitExceeded => 34,
            Error::HotKeySetTxRateLimitExceeded => 35,
            Error::StakeRateLimitExceeded => 36,
            Error::UnstakeRateLimitExceeded => 37,
            Error::SubNetRegistrationDisabled => 38,
            Error::TooManyRegistrationsThisInterval => 39,
            Error::TransactorAccountShouldBeHotKey => 40,
            Error::NotSenateMember => 41,
            Error::FaucetDisabled => 42,
            Error::NotSubnetOwner => 43,
            Error::RegistrationNotPermittedOnRootSubnet => 44,
            Error::StakeTooLowForRoot => 45,
            Error::AllNetworksInImmunity => 46,
            Error::NotEnoughBalanceToPaySwapHotKey => 47,
            Error::NotRootSubnet => 48,
            Error::CanNotSetRootNetworkWeights => 49,
            Error::NoNeuronIdAvailable => 50,
            Error::NomStakeBelowMinimumThreshold => 51,
            Error::DelegateTakeTooLow => 52,
            Error::DelegateTakeTooHigh => 53,
            Error::WeightsCommitNotAllowed => 54,
            Error::NoWeightsCommitFound => 55,
            Error::InvalidRevealCommitTempo => 56,
            Error::InvalidRevealCommitHashNotMatch => 57,
            Error::CommitRevealEnabled => 58,
            Error::CommitRevealDisabled => 59,
            Error::CouldNotJoinSenate => 60,
            Error::LiquidAlphaDisabled => 61,
            Error::AlphaHighTooLow => 62,
            Error::AlphaLowOutOfRange => 63,
            Error::ColdKeyAlreadyAssociated => 64,
            Error::ColdKeySwapTxRateLimitExceeded => 65,
            Error::NewColdKeyIsSameWithOld => 66,
            Error::NotExistColdkey => 67,
            Error::NotEnoughBalanceToPaySwapColdKey => 68,
            Error::NoBalanceToTransfer => 69,
            Error::SameColdkey => 70,
            Error::ColdkeyIsInArbitration => 71,
            Error::DuplicateColdkey => 72,
            Error::ColdkeySwapError => 73,
            Error::InsufficientBalanceToPerformColdkeySwap => 74,
            Error::MaxColdkeyDestinationsReached => 75,
            Error::InvalidChild => 76,
            Error::DuplicateChild => 77,
            Error::ProportionOverflow => 78,
            Error::TooManyChildren => 79,
            Error::TxRateLimitExceeded => 80,
            Error::SwapColdkeyOnlyCallableByRoot => 81,
            Error::SwapAlreadyScheduled => 82,
            Error::FailedToSchedule => 83,
            Error::NewColdKeyIsHotkey => 84,
            Error::NewColdkeyIsInArbitration => 85,
            Error::InvalidChildkeyTake => 86,
            Error::TxChildkeyTakeRateLimitExceeded => 87,
            Error::InvalidIdentity => 88,
            Error::ColdkeyInSwapSchedule => 89,
            Error::CommitWeightsBelowMinStake => 90,
            Error::RevealWeightsBelowMinStake => 91,
            Error::SetWeightsBelowMinStake => 92,
            Error::SetRootWeightsBelowMinStake => 93,
            Error::MaxIntervalRegistrationsReached => 94,
            Error::__Ignore(_, _) => {
                unreachable!("Mismatch between pallet error enum and this test")
            }
        };
    });
}
