...
fn test_stake_into_subnet_hotkey_coldkey_combination() {
    new_test_ext(1).execute_with(|| {
        ...
        assert_eq!(
            Alpha::<Test>::get((hotkey1.clone(), coldkey1.clone(), netuid)),
            stake_amount,
        ...
        assert_eq!(
            Alpha::<Test>::get((hotkey2.clone(), coldkey1.clone(), netuid)),
            stake_amount,
            "Alpha storage should be updated correctly"
        );
        assert_eq!(
        ...
        assert_eq!(
            Alpha::<Test>::get((hotkey1.clone(), coldkey2.clone(), netuid)),
            stake_amount,
            "Alpha storage should be updated correctly"
        );
        assert_eq!(
...
fn test_stake_into_subnet_storage_consistency() {
    new_test_ext(1).execute_with(|| {
        ...
        assert_eq!(
            Alpha::<Test>::get((hotkey, coldkey, netuid + 1)),
            0,
...
fn test_unstake_from_subnet_multiple_hotkeys() {
    new_test_ext(1).execute_with(|| {
        ...
        assert_eq!(
            Alpha::<Test>::get((hotkey1, coldkey, netuid)),
            0,
            "Alpha for hotkey1-coldkey pair should be zero"
        );
        assert_eq!(
            Alpha::<Test>::get((hotkey2, coldkey, netuid)),
            alpha_to_stake,
