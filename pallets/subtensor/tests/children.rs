...
fn test_get_stake_for_hotkey_on_subnet_max_network_stake() {
    new_test_ext(1).execute_with(|| {
        ...
        increase_stake_on_coldkey_hotkey_account(&coldkey, &parent, network_max_stake, netuid);
        // Increase stake to the network max on child
        increase_stake_on_coldkey_hotkey_account(&coldkey, &child, network_max_stake, netuid);
