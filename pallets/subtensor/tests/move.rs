...
fn test_do_move_success() {
    new_test_ext(1).execute_with(|| {
        ...
        let alpha = StakedAlpha::<Test>::get((origin_hotkey, coldkey, netuid));
...
fn test_do_move_different_subnets() {
    new_test_ext(1).execute_with(|| {
        ...
        let alpha = StakedAlpha::<Test>::get((origin_hotkey, coldkey, origin_netuid));
...
fn test_do_move_multiple_times() {
    new_test_ext(1).execute_with(|| {
        ...
        let alpha = StakedAlpha::<Test>::get((hotkey1, coldkey, netuid));
...
fn test_do_move_same_hotkey() {
    new_test_ext(1).execute_with(|| {
        ...
        let alpha = StakedAlpha::<Test>::get((hotkey, coldkey, netuid));
